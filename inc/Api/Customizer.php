...
use Bootpress\Api\Customizer\Sidebar;
use Bootpress\Api\Customizer\Header;
use Bootpress\Api\Customizer\Footer;
...
class Customizer 
{
	...
	public function output()
	{
		echo '<!--Customizer CSS--> <style type="text/css">';
			echo self::css( '#sidebar', 'background-color', 'Bootpress_sidebar_background_color' );
			echo self::css( '.site-footer', 'background-color', 'Bootpress_footer_background_color' );
			echo self::css( '.site-header', 'background-color', 'Bootpress_header_background_color' );
			echo self::css( '.site-header', 'color', 'Bootpress_header_text_color' );
			echo self::css( '.site-header a', 'color', 'Bootpress_header_link_color' );
